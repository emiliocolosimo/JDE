...
SELECT RRN(JRGDTA94C.F4211) AS ID_ORDER ,
    ...
    CASE 
        ...
        TRIM(COALESCE(SDLOTN, '')) AS SDLOTN,  
        TRIM(COALESCE((SELECT ABAC20 FROM JRGDTA94C.F0101 WHERE ABAN8=IOVEND), '')) AS ABAC20
        FROM JRGDTA94C.F4211 
    	LEFT JOIN JRGDTA94C.F4108 ON IOLOTN=SDLOTN AND IOLITM=SDLITM AND IOMCU=SDMCU
