...
U.SDFRGD,
U.SDEUSE, 
TRIM(VARCHAR_FORMAT((DECIMAL(U.SDSOQS/100, 10, 4)),'9999999990.00')) as SDSOQS, 
U.SDUPRC,
U.SDFUP,
U.SDUOM4, 
TRIM(VARCHAR_FORMAT((DECIMAL(U.SDAEXP/100, 10, 4)),'9999999990.00')) as SDAEXP,  
TRIM(VARCHAR_FORMAT((DECIMAL(U.SDFEA/100, 10, 4)),'9999999990.00')) as SDFEA, 
U.SDCRCD,
U.SDPDDJ,
U.SDADDJ,
U.SDAN8, 
...
LEFT JOIN JRGDTA94C.F0111 ON U.SDAN8 = WWAN8 AND WWIDLN = 0 

"; 
/*
, 
COALESCE(F0111.WWMLNM, '') AS WWMLNM 
LEFT JOIN JRGDTA94C.F0111 ON U.SDAN8 = F0111.WWAN8 AND F0111.WWIDLN = 0 
*/
