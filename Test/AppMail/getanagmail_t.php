...
,trim(coalesce((select SUM(SDAEXP/100) from ".$curLib.".F554211 where ".$curLib.".F0101.ABAN8=".$curLib.".F554211.SDAN8 AND SDDCTO NOT IN ('OF' , 'SQ')), ''))
,trim(coalesce((select SUM(SDAEXP/100) from ".$curLib.".F554211 where ".$curLib.".F0101.ABAN8=".$curLib.".F554211.SDAN8 AND SDDCTO IN ('OF' , 'SQ')), ''))
,trim(coalesce((SELECT max(A2KY)
FROM ".$curLib.".F01092 WHERE ".$curLib.".F0101.ABAN8 = ".$curLib.".F01092.A2AN8 AND A2TYDT = 'CV' AND rrn(".$curLib.".F01092) = (SELECT MAX(rrn(".$curLib.".F01092)) FROM ".$curLib.".F01092 WHERE ".$curLib.".F0101.ABAN8 = ".$curLib.".F01092.A2AN8 
AND A2TYDT = 'CV')), '')),
