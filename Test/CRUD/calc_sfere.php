...
class calc_sfere extends WebSmartObject
{
	...
	protected function auto_articolo() {
		$term = xl_get_parameter("term");
		
		$query = "SELECT JRGDTA94C.F4101.IMLITM AS IMLITM, JRGDTA94C.F4101.IMDSC1 AS IMDSC1 
		FROM JRGDTA94C.F4101 
		WHERE UPPER(IMLITM) LIKE :IMLITM 
		";	
		...
		$stmt->bindValue(':IMLITM', '%'.strtoupper($term).'%', PDO::PARAM_STR);
		...
		{ 
			...
			if($nr>0) echo ','; 
			echo '{"id":'.json_encode($IMLITM).',"label":'.json_encode($IMLITM).'}'; 
	...
	protected function calcola()
	{
		...
		if($fld1!="") $risultato1 = $fld1 / ($UMCONV/10000000);
		if($fld2!="") $risultato2 = $fld2 * ($UMCONV/10000000);
 ...
 echo number_format($numSfereAlKg,0,",","."); 
		echo <<<SEGDTA
            ...
            <div id="fld1-grp" class="form-group row">
              <label class="col-sm-4 text-right">Kg:</label>
              <div class="col-sm-8">
            ...
            <div id="fld2-grp" class="form-group row">
              <label class="col-sm-4 text-right">Pz:</label>
              <div class="col-sm-8">
            ...
            <div class="form-group row">
              <label class="col-sm-4 text-right">Sfere in <span id="fld1-span"></span> KG::</label>
              <div class="col-sm-8 risultati" id="risultato-1"></div>
            </div>
            <div class="form-group row">
              <label class="col-sm-4 text-right">Peso di <span id="fld2-span"></span> PZ:</label>
...
SEGDTA;
    ...
    <script type="text/javascript">
		jQuery(function() {
			...
			$("#fld1").change(function(e){
				$("#fld1-span").html($(this).val());	
			});
			$("#fld2").change(function(e){
				$("#fld2-span").html($(this).val());	
			});
...
<html>
  <head>
    ...
    <script src="/crud/websmart/v13.2/js/jquery.min.js"></script>
    <script src="/crud/websmart/v13.2/js/jquery-ui.min.js"></script> 
    <script src="/crud/websmart/v13.2/Responsive/js/bootstrap.min.js"></script>
  </head>
  <body class="display-list">
    <div id="outer-content">
...
<script type="text/javascript">
	...
	jQuery(function() {
		...
		$("#filter_IMLITM").autocomplete({
			source: "calc_sfere.php?task=auto_articolo",
			minLength: 3,
			select: function( event, ui ) {
				$('#filter_IMLITM').val(ui.item.id); 
			}
		});
...
SEGDTA;
	...
	function __construct()
	{
		...
		// Last Generated CRC: 983A57E6 528B09EF 310E5119 4602700E
		// Last Generated Date: 2024-04-02 18:03:14
