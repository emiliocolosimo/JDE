...
//	Program Title:		Non conformità - Lista non conformità
//	Created by:			matti
...
<html>
  <head>
    ...
    <title>Non conformità - Lista non conformità</title>
    ...
    <div id="outer-content">
      ...
      <div id="page-content">
        <div id="content-header">
          <h1 class="title">Lista non conformità</h1>
          <!--
          <span class="add-link">
...
<html>
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Pragma" content="no-cache" />
    <title>Non conformità - Lista non conformità - $mode</title>
  ...
  <body class="single-record display-record">
    <div id="outer-content">
      ...
      <div id="page-content">
        <div id="content-header">
          <h1 class="title">Non conformità - Lista non conformità - $mode</h1>
        </div>
        <div class="clearfix"></div>
        <div id="contents">
