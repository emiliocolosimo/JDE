...
Tipo Cliente – menù a tendina con solo questi due valori: Cliente , Prospect –

Cliente Where exists select * from f564211 where sddcto not in (‘OF’ , ‘SQ’)

Prospect where not exists codice cliente=sdan8 and sddcto not in (‘OF’ , ‘SQ’) – cioè tutti gli altri
