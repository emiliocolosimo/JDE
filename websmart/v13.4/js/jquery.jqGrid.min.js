...
m))}else k=new Date(1E3*parseFloat(e));else k=new Date(h.y,h.m,h.d,h.h,h.i,h.s,h.u);f.userLocalTime&&0===m&&(m-=(new Date).getTimezoneOffset(),0<m&&k.setTime(Number(Number(k)+6E4*m)));if(void 0===c)return k;f.masks.hasOwnProperty(c)?c=f.masks[c]:c||(c="Y-m-d");b=k.getHours();e=k.getMinutes();h=k.getDate();m=k.getMonth()+1;d=k.getTimezoneOffset();l=k.getSeconds();p=k.getMilliseconds();var r=k.getDay(),q=k.getFullYear(),n=(r+6)%7+1,u=(new Date(q,m-1,h)-new Date(q,0,1))/864E5,v={d:g(h),D:f.dayNames[r],
j:h,l:f.dayNames[r+7],N:n,S:f.S(h),w:r,z:u,W:5>n?Math.floor((u+n-1)/7)+1:Math.floor((u+n-1)/7)||(4>((new Date(q-1,0,1)).getDay()+6)%7?53:52),F:f.monthNames[m-1+12],m:g(m),M:f.monthNames[m-1],n:m,t:"?",L:"?",o:"?",Y:q,y:String(q).substring(2),a:12>b?f.AmPm[0]:f.AmPm[1],A:12>b?f.AmPm[2]:f.AmPm[3],B:"?",g:b%12||12,G:b,h:g(b%12||12),H:g(b),i:g(e),s:g(l),u:p,e:"?",I:"?",O:(0<d?"-":"+")+g(100*Math.floor(Math.abs(d)/60)+Math.abs(d)%60,4),P:"?",T:(String(k).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||
...
b:b.toLowerCase()};a.each(b,function(d,b){r=""!==c?a.jgrid.getAccessor(b,c):b;void 0===r&&(r="");r=q(r,b);n.push({vSort:r,index:d})});a.isFunction(k)?n.sort(function(a,d){a=a.vSort;d=d.vSort;return k.call(this,a,d,m)}):n.sort(function(a,d){a=a.vSort;d=d.vSort;return f._compare(a,d,m)});h=0;for(var v=b.length;h<v;)e=n[h].index,p.push(b[e]),h++;return p};this._getGroup=function(d,b,c,e,h){var g=[],k=null,l=null,n;a.each(f._getOrder(d,b,c,e,h),function(d,c){n=a.jgrid.getAccessor(c,b);null==n&&(n="");
...
(l+=" "+p+"="+g[p])}return'<tr role="row" id="'+b+'" tabindex="'+k+'" class="'+e+'"'+(""===c?"":' style="'+c+'"')+l+">"},D=function(b,c,e,f,h){var g=new Date,k="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,p="local"===d.p.datatype?"local":"xml";k&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var n=a(d),m,q,u=0,C,L=!0===d.p.multiselect?1:0,O=0,z,D=!0===d.p.rownumbers?
1:0,I,J=[],Q,A={},G,K,F=[],P=!0===d.p.altRows?d.p.altclass:"",ja;!0===d.p.subGrid&&(O=1,z=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(J=y(p));I=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;p=-1===String(I).indexOf("[")?J.length?function(b,d){return a(I,b).text()||d}:function(b,d){return a(l.cell,b).eq(I).text()||d}:function(a,b){return a.getAttribute(I.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
l.total),1);d.p.records=r(a.jgrid.getXmlData(b,l.records));a.isFunction(l.userdata)?d.p.userData=l.userdata.call(d,b)||{}:a.jgrid.getXmlData(b,l.userdata,!0).each(function(){d.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,l.root,!0);(b=a.jgrid.getXmlData(b,l.row,!0))||(b=[]);var T=b.length,H=0,V=[],M=parseInt(d.p.rowNum,10),N=d.p.scroll?a.jgrid.randId():1;0<T&&0>=d.p.page&&(d.p.page=1);if(b&&T){h&&(M*=h+1);h=a.isFunction(d.p.afterInsertRow);var U=!1,Z;d.p.grouping&&
(U=!0===d.p.groupingView.groupCollapse,Z=a.jgrid.getMethod("groupingPrepare"));for(;H<T;){G=b[H];K=p(G,N+H);K=d.p.idPrefix+K;m=0===e?0:e+1;ja=1===(m+H)%2?P:"";var ea=F.length;F.push("");D&&F.push(t(0,H,d.p.page,d.p.rowNum));L&&F.push(x(K,D,H,!1));O&&F.push(z.call(n,L+D,H+e));if(l.repeatitems){Q||(Q=B(L+O+D));var da=a.jgrid.getXmlData(G,l.cell,!0);a.each(Q,function(a){var b=da[this];if(!b)return!1;C=b.textContent||b.text;A[d.p.colModel[a+L+O+D].name]=C;F.push(v(K,C,a+L+O+D,H+e,G,A))})}else for(m=0;m<
J.length;m++)C=a.jgrid.getXmlData(G,J[m]),A[d.p.colModel[m+L+O+D].name]=C,F.push(v(K,C,m+L+O+D,H+e,G,A));F[ea]=E(K,U,ja,A,G,!1);F.push("</tr>");d.p.grouping&&(V.push(F),d.p.groupingView._locgr||Z.call(n,A,H),F=[]);if(k||!0===d.p.treeGrid)A._id_=a.jgrid.stripPref(d.p.idPrefix,K),d.p.data.push(A),d.p._index[A._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(F.join("")),n.triggerHandler("jqGridAfterInsertRow",[K,A,G]),h&&d.p.afterInsertRow.call(d,K,A,G),F=[]);A={};u++;H++;if(u===
M)break}}!0===d.p.gridview&&(q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?k||(n.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,M),V=null):!0===d.p.treeGrid&&0<q?a(d.rows[q]).after(F.join("")):(d.firstElementChild.innerHTML+=F.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{n.jqGrid("addSubGrid",L+D)}catch(ba){}d.p.totaltime=new Date-g;0<u&&0===d.p.records&&(d.p.records=T);F=null;if(!0===d.p.treeGrid)try{n.jqGrid("setTreeNode",q+1,u+q+1)}catch(R){}d.p.reccount=u;d.p.treeANode=
-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);k&&(d.p.records=T,d.p.lastpage=Math.ceil(T/M));f||d.updatepager(!1,!0);if(k){for(;u<T;){G=b[u];K=p(G,u+N);K=d.p.idPrefix+K;if(l.repeatitems){Q||(Q=B(L+O+D));var ca=a.jgrid.getXmlData(G,l.cell,!0);a.each(Q,function(a){var b=ca[this];if(!b)return!1;C=b.textContent||b.text;A[d.p.colModel[a+L+O+D].name]=C})}else for(m=0;m<J.length;m++)C=a.jgrid.getXmlData(G,J[m]),A[d.p.colModel[m+L+O+D].name]=C;A._id_=a.jgrid.stripPref(d.p.idPrefix,
K);d.p.grouping&&Z.call(n,A,u);d.p.data.push(A);d.p._index[A._id_]=d.p.data.length-1;A={};u++}d.p.grouping&&(d.p.groupingView._locgr=!0,n.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,M),V=null)}}},G=function(b,c,e,f,h){var g=new Date;if(b){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var k,l="local"!==d.p.datatype&&d.p.loadonce||"jsonstring"===d.p.datatype;l&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;"local"===d.p.datatype?(c=d.p.localReader,
k="local"):(c=d.p.jsonReader,k="json");var p=a(d),n=0,m,q,u,C=[],L=d.p.multiselect?1:0,O=!0===d.p.subGrid?1:0,z,D=!0===d.p.rownumbers?1:0,I=B(L+O+D);k=y(k);var J,A,G,K={},Q,F,H=[],ja=!0===d.p.altRows?d.p.altclass:"",T;d.p.page=r(a.jgrid.getAccessor(b,c.page),d.p.page);d.p.lastpage=r(a.jgrid.getAccessor(b,c.total),1);d.p.records=r(a.jgrid.getAccessor(b,c.records));d.p.userData=a.jgrid.getAccessor(b,c.userdata)||{};O&&(z=a.jgrid.getMethod("addSubGridCell"));G=!1===d.p.keyName?a.isFunction(c.id)?c.id.call(d,
b):c.id:d.p.keyName;A=a.jgrid.getAccessor(b,c.root);null==A&&a.isArray(b)&&(A=b);A||(A=[]);b=A.length;q=0;0<b&&0>=d.p.page&&(d.p.page=1);var P=parseInt(d.p.rowNum,10),V=d.p.scroll?a.jgrid.randId():1,M=!1,N;h&&(P*=h+1);"local"!==d.p.datatype||d.p.deselectAfterSort||(M=!0);var Z=a.isFunction(d.p.afterInsertRow),U=[],ea=!1,da;d.p.grouping&&(ea=!0===d.p.groupingView.groupCollapse,da=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){h=A[q];F=a.jgrid.getAccessor(h,G);void 0===F&&("number"===typeof G&&null!=
d.p.colModel[G+L+O+D]&&(F=a.jgrid.getAccessor(h,d.p.colModel[G+L+O+D].name)),void 0===F&&(F=V+q,0===C.length&&c.cell&&(m=a.jgrid.getAccessor(h,c.cell)||h,F=null!=m&&void 0!==m[G]?m[G]:F)));F=d.p.idPrefix+F;m=1===e?0:e;T=1===(m+q)%2?ja:"";M&&(N=d.p.multiselect?-1!==a.inArray(F,d.p.selarrrow):F===d.p.selrow);var ba=H.length;H.push("");D&&H.push(t(0,q,d.p.page,d.p.rowNum));L&&H.push(x(F,D,q,N));O&&H.push(z.call(p,L+D,q+e));J=k;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,c.cell)||h),a.isArray(h)&&
(J=I));for(u=0;u<J.length;u++)m=a.jgrid.getAccessor(h,J[u]),K[d.p.colModel[u+L+O+D].name]=m,H.push(v(F,m,u+L+O+D,q+e,h,K));H[ba]=E(F,ea,T,K,h,N);H.push("</tr>");d.p.grouping&&(U.push(H),d.p.groupingView._locgr||da.call(p,K,q),H=[]);if(l||!0===d.p.treeGrid)K._id_=a.jgrid.stripPref(d.p.idPrefix,F),d.p.data.push(K),d.p._index[K._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(H.join("")),p.triggerHandler("jqGridAfterInsertRow",[F,K,h]),Z&&d.p.afterInsertRow.call(d,
F,K,h),H=[]);K={};n++;q++;if(n===P)break}!0===d.p.gridview&&(Q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?l||(p.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,P),U=null):!0===d.p.treeGrid&&0<Q?a(d.rows[Q]).after(H.join("")):(d.firstElementChild.innerHTML+=H.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{p.jqGrid("addSubGrid",L+D)}catch(R){}d.p.totaltime=new Date-g;0<n&&0===d.p.records&&(d.p.records=b);if(!0===d.p.treeGrid)try{p.jqGrid("setTreeNode",Q+1,n+Q+1)}catch(ca){}d.p.reccount=
n;d.p.treeANode=-1;d.p.userDataOnFooter&&p.jqGrid("footerData","set",d.p.userData,!0);l&&(d.p.records=b,d.p.lastpage=Math.ceil(b/P));f||d.updatepager(!1,!0);if(l){for(;n<b&&A[n];){h=A[n];F=a.jgrid.getAccessor(h,G);void 0===F&&("number"===typeof G&&null!=d.p.colModel[G+L+O+D]&&(F=a.jgrid.getAccessor(h,d.p.colModel[G+L+O+D].name)),void 0===F&&(F=V+n,0===C.length&&c.cell&&(e=a.jgrid.getAccessor(h,c.cell)||h,F=null!=e&&void 0!==e[G]?e[G]:F)));if(h){F=d.p.idPrefix+F;J=k;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,
c.cell)||h),a.isArray(h)&&(J=I));for(u=0;u<J.length;u++)K[d.p.colModel[u+L+O+D].name]=a.jgrid.getAccessor(h,J[u]);K._id_=a.jgrid.stripPref(d.p.idPrefix,F);d.p.grouping&&da.call(p,K,n);d.p.data.push(K);d.p._index[K._id_]=d.p.data.length-1;K={}}n++}d.p.grouping&&(d.p.groupingView._locgr=!0,p.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,P))}}},z=function(){function b(a){var d=0,c,e,f,g,k;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(c=0;c<
a.groups.length;c++){0<d&&e&&v.or();try{b(a.groups[c])}catch(l){alert(l)}d++}e&&v.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(c=0;c<a.rules.length;c++)k=a.rules[c],g=a.groupOp.toString().toUpperCase(),u[k.op]&&k.field&&(0<d&&g&&"OR"===g&&(v=v.or()),v=u[k.op](v,g)(k.field,k.data,h[k.field])),d++;f&&v.orEnd()}catch(p){alert(p)}}var c=d.p.multiSort?[]:"",e=[],f=!1,h={},g=[],k=[],l,p,n;if(a.isArray(d.p.data)){var m=d.p.grouping?d.p.groupingView:
...
a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},v=a.jgrid.from(d.p.data);d.p.ignoreCase&&(v=v.ignoreCase());if(!0===d.p.search){var t=d.p.postData.filters;if(t)"string"===typeof t&&(t=a.jgrid.parse(t)),b(t);else try{v=u[d.p.postData.searchOper](v)(d.p.postData.searchField,d.p.postData.searchString,h[d.p.postData.searchField])}catch(y){}}if(d.p.grouping)for(q=0;q<r;q++)v.orderBy(k[q],m.groupOrder[q],
g[q].stype,g[q].srcfmt);d.p.multiSort?a.each(c,function(a){v.orderBy(this,e[a],h[this].stype,h[this].srcfmt,h[this].sfunc)}):c&&d.p.sortorder&&f&&("DESC"===d.p.sortorder.toUpperCase()?v.orderBy(d.p.sortname,"d",h[c].stype,h[c].srcfmt,h[c].sfunc):v.orderBy(d.p.sortname,"a",h[c].stype,h[c].srcfmt,h[c].sfunc));var t=v.select(),w=parseInt(d.p.rowNum,10),x=t.length,E=parseInt(d.p.page,10),B=Math.ceil(x/w),L={};if((d.p.search||d.p.resetsearch)&&d.p.grouping&&d.p.groupingView._locgr){d.p.groupingView.groups=
[];var O,C=a.jgrid.getMethod("groupingPrepare"),D,z;if(d.p.footerrow&&d.p.userDataOnFooter){for(D in d.p.userData)d.p.userData.hasOwnProperty(D)&&(d.p.userData[D]=0);z=!0}for(O=0;O<x;O++){if(z)for(D in d.p.userData)d.p.userData[D]+=parseFloat(t[O][D]||0);C.call(a(d),t[O],O,w)}}t=t.slice((E-1)*w,E*w);h=v=null;L[d.p.localReader.total]=B;L[d.p.localReader.page]=E;L[d.p.localReader.records]=x;L[d.p.localReader.root]=t;L[d.p.localReader.userdata]=d.p.userData;t=null;return L}}},P=function(){d.grid.hDiv.loading=
...
d.p._nvtd[0]=f?Math.floor((d.p.width-f)/2):Math.floor(d.p.width/3);d.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+g).bind("change",function(){if(!m("records"))return!1;d.p.page=Math.round(d.p.rowNum*(d.p.page-1)/this.value-.5)+1;d.p.rowNum=this.value;d.p.pager&&a(".ui-pg-selbox",d.p.pager).val(this.value);d.p.toppager&&a(".ui-pg-selbox",d.p.toppager).val(this.value);M();return!1});!0===d.p.pgbuttons&&(a(".ui-pg-button","#"+g).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":
...
k=!1,b=e-1);if(!m(this.id))return!1;this.id==="first"+c&&h&&(d.p.page=1,f=!0);this.id==="prev"+c&&g&&(d.p.page=b-1,f=!0);this.id==="next"+c&&k&&(d.p.page=b+1,f=!0);this.id==="last"+c&&l&&(d.p.page=e,f=!0);f&&M();return!1}));!0===d.p.pginput&&a("input.ui-pg-input","#"+g).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!m("user"))return!1;a(this).val(r(a(this).val(),1));d.p.page=0<a(this).val()?a(this).val():d.p.page;M();return!1}return this})},Y=function(b,c){var e,f="",h=d.p.colModel,
...
(b[0]=d.p.width-b[0]);b[0]-=d.grid.bDiv.scrollLeft;b.push(a(d.grid.hDiv).position().top);b.push(a(d.grid.bDiv).offset().top-a(d.grid.hDiv).offset().top+a(d.grid.bDiv).height());return b},U=function(b){var c,e=d.grid.headers,f=a.jgrid.getCellIndex(b);for(c=0;c<e.length;c++)if(b===e[c].el){f=c;break}return f},N;this.p.id=this.id;-1===a.inArray(d.p.multikey,["shiftKey","altKey","ctrlKey"])&&(d.p.multikey=!1);d.p.keyName=!1;for(k=0;k<d.p.colModel.length;k++)N="string"===typeof d.p.colModel[k].template?
null!=a.jgrid.cmTemplate&&"object"===typeof a.jgrid.cmTemplate[d.p.colModel[k].template]?a.jgrid.cmTemplate[d.p.colModel[k].template]:{}:d.p.colModel[k].template,d.p.colModel[k]=a.extend(!0,{},d.p.cmTemplate,N||{},d.p.colModel[k]),!1===d.p.keyName&&!0===d.p.colModel[k].key&&(d.p.keyName=d.p.colModel[k].name);d.p.sortorder=d.p.sortorder.toLowerCase();a.jgrid.cell_width=a.jgrid.cellWidth();!0===d.p.grouping&&(d.p.scroll=!1,d.p.rownumbers=!1,d.p.treeGrid=!1,d.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(L){}"local"!==
d.p.datatype&&(d.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(d).jqGrid("setSubGrid")}catch(O){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?d.p.multiselectWidth+d.p.cellLayout:d.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:d.p.rownumWidth,
...
d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(I(),C());N="<thead><tr class='ui-jqgrid-labels' role='row'>";var K,Q,Z,V,T,H,J,ga,ea=ga="",ia=[],da=[];Q=[];if(!0===d.p.shrinkToFit&&!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=
!1;break}"horizontal"===d.p.viewsortcols[1]&&(ga=" ui-i-asc",ea=" ui-i-desc");K=c?"class='ui-th-div-ie'":"";ga="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ea+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'></span></span>");if(d.p.multiSort)for(ia=d.p.sortname.split(","),k=0;k<ia.length;k++)Q=a.trim(ia[k]).split(" "),
ia[k]=a.trim(Q[0]),da[k]=Q[1]?a.trim(Q[1]):d.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)Q=d.p.headertitles?' title="'+a.jgrid.stripHtml(d.p.colNames[k])+'"':"",N+="<th id='"+d.p.id+"_"+d.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+Q+">",Q=d.p.colModel[k].index||d.p.colModel[k].name,N+="<div id='jqgh_"+d.p.id+"_"+d.p.colModel[k].name+"' "+K+">"+d.p.colNames[k],d.p.colModel[k].width=d.p.colModel[k].width?parseInt(d.p.colModel[k].width,10):
150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",Q===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(Q=a.inArray(Q,ia),-1!==Q&&(d.p.colModel[k].lso=da[Q])),N+=ga+"</div></th>";N+="</tr></thead>";ga=null;a(this).append(N);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var ka=[],ba;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=
...
d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!0),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).addClass("ui-state-highlight")))}),ba=!0,ka=[]):(a(d.rows).each(function(c){0<c&&!(a(this).hasClass("ui-subgrid")||a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id))[d.p.useProp?"prop":"attr"]("checked",!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),ka.push(this.id),b&&
(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,ba=!1);a(d).triggerHandler("jqGridSelectAll",[ba?d.p.selarrrow:ka,ba]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,ba?d.p.selarrrow:ka,ba)})}!0===d.p.autowidth&&(N=a(m).innerWidth(),d.p.width=0<N?N:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,g=r(d.p.scrollOffset,
...
a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");N=a("thead:first",d).get(0);var fa="";d.p.footerrow&&(fa+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=a("tr:first",N),ha="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;
a("th",p).each(function(b){Z=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(V=document.createElement("span"),a(V).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):V="";a(this).css("width",Z+"px").prepend(V);V=null;var c="";d.p.colModel[b].hidden&&(a(this).css("display","none"),c="display:none;");ha+="<td role='gridcell' style='height:0px;width:"+Z+"px;"+
c+"'></td>";h.headers[b]={width:Z,el:this};T=d.p.colModel[b].sortable;"boolean"!==typeof T&&(T=d.p.colModel[b].sortable=!0);c=d.p.colModel[b].name;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&d.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");T&&(d.p.multiSort?d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),d.p.colModel[b].lso&&a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):d.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.colModel[b].lso,
this).removeClass("ui-state-disabled")):d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),b===d.p.lastsort&&a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")):b===d.p.lastsort&&""!==d.p.sortname&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")));d.p.footerrow&&(fa+="<td role='gridcell' "+q(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){if(1===a(b.target).closest("th>span.ui-jqgrid-resize").length){var c=
U(this);if(!0===d.p.forceFit){var e=d.p,f=c,g;for(g=c+1;g<d.p.colModel.length;g++)if(!0!==d.p.colModel[g].hidden){f=g;break}e.nv=f-c}h.dragStart(c,b,ca(c));return!1}}).click(function(b){if(d.p.disableClick)return d.p.disableClick=!1;var c="th>div.ui-jqgrid-sortable",e,f;d.p.viewsortcols[2]||(c="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(c);if(1===b.length){var h;if(d.p.frozenColumns){var g=a(this)[0].id.substring(d.p.id.length+1);a(d.p.colModel).each(function(a){if(this.name===g)return h=
a,!1})}else h=U(this);d.p.viewsortcols[2]||(e=!0,f=b.attr("sort"));null!=h&&F(a("div",this)[0].id,h,e,f,this);return!1}});if(d.p.sortable&&a.fn.sortable)try{a(d).jqGrid("sortableColumns",p)}catch(oa){}d.p.footerrow&&(fa+="</tr></tbody></table>");ha+="</tr>";p=document.createElement("tbody");this.appendChild(p);a(this).addClass("ui-jqgrid-btable").append(ha);var ha=null,p=a("<table class='ui-jqgrid-htable' style='width:"+d.p.tblwidth+"px' role='presentation' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(N),
X=d.p.caption&&!0===d.p.hiddengrid?!0:!1;k=a("<div class='ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'></div>");N=null;h.hDiv=document.createElement("div");a(h.hDiv).css({width:h.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(k);a(k).append(p);p=null;X&&a(h.hDiv).hide();d.p.pager&&("string"===typeof d.p.pager?"#"!==d.p.pager.substr(0,1)&&(d.p.pager="#"+d.p.pager):d.p.pager="#"+a(d.p.pager).attr("id"),a(d.p.pager).css({width:h.width+"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),
X&&a(d.p.pager).hide(),W(d.p.pager,""));!1===d.p.cellEdit&&!0===d.p.hoverrows&&a(d).bind("mouseover",function(b){J=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(J).attr("class")&&a(J).addClass("ui-state-hover")}).bind("mouseout",function(b){J=a(b.target).closest("tr.jqgrow");a(J).removeClass("ui-state-hover")});var S,aa,la;a(d).before(h.hDiv).click(function(b){H=b.target;J=a(H,d.rows).closest("tr.jqgrow");if(0===a(J).length||-1<J[0].className.indexOf("ui-state-disabled")||(a(H,d).closest("table.ui-jqgrid-btable").attr("id")||
"").replace("_frozen","")!==d.id)return this;var c=a(H).hasClass("cbox"),e=a(d).triggerHandler("jqGridBeforeSelectRow",[J[0].id,b]),e=!1===e||"stop"===e?!1:!0;if(a.isFunction(d.p.beforeSelectRow)){var f=d.p.beforeSelectRow.call(d,J[0].id,b);if(!1===f||"stop"===f)e=!1}if("A"!==H.tagName&&("INPUT"!==H.tagName&&"TEXTAREA"!==H.tagName&&"OPTION"!==H.tagName&&"SELECT"!==H.tagName||c)){S=J[0].id;H=a(H).closest("tr.jqgrow>td");0<H.length&&(aa=a.jgrid.getCellIndex(H),la=a(H).closest("td,th").html(),a(d).triggerHandler("jqGridCellSelect",
[S,aa,la,b]),a.isFunction(d.p.onCellSelect)&&d.p.onCellSelect.call(d,S,aa,la,b));if(!0===d.p.cellEdit)if(d.p.multiselect&&c&&e)a(d).jqGrid("setSelection",S,!0,b);else if(0<H.length){S=J[0].rowIndex;try{a(d).jqGrid("editCell",S,aa,!0)}catch(h){}}if(e)if(d.p.multikey)b[d.p.multikey]?a(d).jqGrid("setSelection",S,!0,b):d.p.multiselect&&c&&(c=a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+S).is(":checked"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+S)[d.p.useProp?"prop":"attr"]("checked",c));else{if(d.p.multiselect&&d.p.multiboxonly&&
!c){var g=d.p.frozenColumns?d.p.id+"_frozen":"";a(d.p.selarrrow).each(function(b,c){var e=a(d).jqGrid("getGridRowById",c);e&&a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c))[d.p.useProp?"prop":"attr"]("checked",!1);g&&(a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g))[d.p.useProp?"prop":"attr"]("checked",!1))});d.p.selarrrow=[]}a(d).jqGrid("setSelection",S,!0,
b)}}}).bind("reloadGrid",function(b,c){!0===d.p.treeGrid&&(d.p.datatype=d.p.treedatatype);c&&c.current&&d.grid.selectionPreserver(d);"local"===d.p.datatype?(a(d).jqGrid("resetSelection"),d.p.data.length&&(I(),C())):d.p.treeGrid||(d.p.selrow=null,d.p.multiselect&&(d.p.selarrrow=[],R(!1)),d.p.savedRow=[]);d.p.scroll&&w.call(d,!0,!1);if(c&&c.page){var e=c.page;e>d.p.lastpage&&(e=d.p.lastpage);1>e&&(e=1);d.p.page=e;d.grid.bDiv.scrollTop=d.grid.prevRowHeight?(e-1)*d.grid.prevRowHeight*d.p.rowNum:0}d.grid.prevRowHeight&&
d.p.scroll?(delete d.p.lastpage,d.grid.populateVisible()):d.grid.populate();!0===d.p._inlinenav&&a(d).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){H=b.target;J=a(H,d.rows).closest("tr.jqgrow");if(0!==a(J).length){S=J[0].rowIndex;aa=a.jgrid.getCellIndex(H);var c=a(d).triggerHandler("jqGridDblClickRow",[a(J).attr("id"),S,aa,b]);if(null!=c||a.isFunction(d.p.ondblClickRow)&&(c=d.p.ondblClickRow.call(d,a(J).attr("id"),S,aa,b),null!=c))return c}}).bind("contextmenu",function(b){H=b.target;
J=a(H,d.rows).closest("tr.jqgrow");if(0!==a(J).length){d.p.multiselect||a(d).jqGrid("setSelection",J[0].id,!0,b);S=J[0].rowIndex;aa=a.jgrid.getCellIndex(H);var c=a(d).triggerHandler("jqGridRightClickRow",[a(J).attr("id"),S,aa,b]);if(null!=c||a.isFunction(d.p.onRightClickRow)&&(c=d.p.onRightClickRow.call(d,a(J).attr("id"),S,aa,b),null!=c))return c}});h.bDiv=document.createElement("div");c&&"auto"===String(d.p.height).toLowerCase()&&(d.p.height="100%");a(h.bDiv).append(a('<div style="position:relative;'+
(c&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:d.p.height+(isNaN(d.p.height)?"":"px"),width:h.width+"px"}).scroll(h.scrollGrid);a("table:first",h.bDiv).css({width:d.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();d.p.multikey&&(a.jgrid.msie?a(h.bDiv).bind("selectstart",function(){return!1}):a(h.bDiv).bind("mousedown",function(){return!1}));X&&a(h.bDiv).hide();h.cDiv=document.createElement("div");
var ma=!0===d.p.hidegrid?a("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' "+(d.p.showhide?"title='"+d.p.showhide+"'":"")+" />").hover(function(){ma.addClass("ui-state-hover")},function(){ma.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"===l?"left":"right","0px"):"";a(h.cDiv).append(ma).append("<span class='ui-jqgrid-title'>"+d.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===l?"-rtl":
...
X&&a(h.ubDiv).hide()):a(h.uDiv).width(h.width).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id),X&&a(h.uDiv).hide());d.p.toppager&&(d.p.toppager=a.jgrid.jqID(d.p.id)+"_toppager",h.topDiv=a("<div id='"+d.p.toppager+"'></div>")[0],d.p.toppager="#"+d.p.toppager,a(h.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(h.width).insertBefore(h.hDiv),W(d.p.toppager,"_t"));d.p.footerrow&&(h.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],k=a("<div class='ui-jqgrid-hbox"+("rtl"===
l?"-rtl":"")+"'></div>"),a(h.sDiv).append(k).width(h.width).insertAfter(h.hDiv),a(k).append(fa),h.footers=a(".ui-jqgrid-ftable",h.sDiv)[0].rows[0].cells,d.p.rownumbers&&(h.footers[0].className="ui-state-default jqgrid-rownum"),X&&a(h.sDiv).hide());k=null;if(d.p.caption){var na=d.p.datatype;!0===d.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",h.cDiv).click(function(b){var c=a.isFunction(d.p.onHeaderClick),e=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",f,g=this;!0===d.p.toolbar[0]&&
...
[d.p.gridstate,b]),c&&(X||d.p.onHeaderClick.call(d,d.p.gridstate,b)))}):"hidden"===d.p.gridstate&&a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideDown("fast",function(){f--;0===f&&(a("span",g).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),X&&(d.p.datatype=na,M(),X=!1),d.p.gridstate="visible",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(d.p.id)).show(),a(d).triggerHandler("jqGridHeaderClick",[d.p.gridstate,b]),c&&
(X||d.p.onHeaderClick.call(d,d.p.gridstate,b)))});return!1}),X&&(d.p.datatype="local",a(".ui-jqgrid-titlebar-close",h.cDiv).trigger("click")))}else a(h.cDiv).hide(),a(h.hDiv).addClass("ui-corner-top");a(h.hDiv).after(h.bDiv).mousemove(function(a){if(h.resizing)return h.dragMove(a),!1});a(".ui-jqgrid-labels",h.hDiv).bind("selectstart",function(){return!1});a(document).bind("mouseup.jqGrid"+d.p.id,function(){return h.resizing?(h.dragEnd(),!1):!0});d.formatCol=q;d.sortData=F;d.updatepager=function(b,
...
a(">td.jqgrid-rownum",d.rows).each(function(b){a(this).html(h+1+b)});c&&d.p.jqgdnd&&a(d).jqGrid("gridDnD","updateDnD");a(d).triggerHandler("jqGridGridComplete");a.isFunction(d.p.gridComplete)&&d.p.gridComplete.call(d);a(d).triggerHandler("jqGridAfterGridComplete")};d.refreshIndex=C;d.setHeadCheckBox=R;d.constructTr=E;d.formatter=function(a,b,c,d,e){return u(a,b,c,d,e)};a.extend(h,{populate:M,emptyRows:w,beginReq:P,endReq:A});this.grid=h;d.addXmlData=function(a){D(a,d.grid.bDiv)};d.addJSONData=function(a){G(a,
...
b),q=h.p._index[r],n;if(h.p.treeGrid)for(n in h.p.treeReader)h.p.treeReader.hasOwnProperty(n)&&delete m[h.p.treeReader[n]];void 0!==q&&(h.p.data[q]=a.extend(!0,h.p.data[q],m));m=null}}catch(u){g=!1}g&&("string"===p?a(l).addClass(c):null!==c&&"object"===p&&a(l).css(c),a(h).triggerHandler("jqGridAfterGridComplete"))});return g},addRowData:function(b,e,c,f){-1==["first","last","before","after"].indexOf(c)&&(c="last");var g=!1,d,h,k,l,p,m,r,q,n="",u,v,x,t,y,B;e&&(a.isArray(e)?(u=!0,v=b):(e=[e],u=!1),
this.each(function(){var w=e.length;p=!0===this.p.rownumbers?1:0;k=!0===this.p.multiselect?1:0;l=!0===this.p.subGrid?1:0;u||(void 0!==b?b=String(b):(b=a.jgrid.randId(),!1!==this.p.keyName&&(v=this.p.keyName,void 0!==e[0][v]&&(b=e[0][v]))));x=this.p.altclass;for(var I=0,C="",E={},D=a.isFunction(this.p.afterInsertRow)?!0:!1;I<w;){t=e[I];h=[];if(u){try{b=t[v],void 0===b&&(b=a.jgrid.randId())}catch(G){b=a.jgrid.randId()}C=!0===this.p.altRows?0===(this.rows.length-1)%2?x:"":""}B=b;b=this.p.idPrefix+b;
p&&(n=this.formatCol(0,1,"",null,b,!0),h[h.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>");k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+b+'" class="cbox"/>',n=this.formatCol(p,1,"",null,b,!0),h[h.length]='<td role="gridcell" '+n+">"+q+"</td>");l&&(h[h.length]=a(this).jqGrid("addSubGridCell",k+p,1));for(r=k+l+p;r<this.p.colModel.length;r++)y=this.p.colModel[r],d=y.name,E[d]=t[d],q=this.formatter(b,a.jgrid.getAccessor(t,d),r,t),n=this.formatCol(r,
1,q,t,b,E),h[h.length]='<td role="gridcell" '+n+">"+q+"</td>";h.unshift(this.constructTr(b,!1,C,E,t,!1));h[h.length]="</tr>";if(0===this.rows.length)a("table:first",this.grid.bDiv).append(h.join(""));else switch(c){case "last":a(this.rows[this.rows.length-1]).after(h.join(""));m=this.rows.length-1;break;case "first":a(this.rows[0]).after(h.join(""));m=1;break;case "after":if(m=a(this).jqGrid("getGridRowById",f))a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[m.rowIndex+1]).after(h):
a(m).after(h.join("")),m=m.rowIndex+1;break;case "before":if(m=a(this).jqGrid("getGridRowById",f))a(m).before(h.join("")),m=m.rowIndex-1}!0===this.p.subGrid&&a(this).jqGrid("addSubGrid",k+p,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[b,t,t]);D&&this.p.afterInsertRow.call(this,b,t,t);I++;"local"===this.p.datatype&&(E[this.p.localReader.id]=B,this.p._index[B]=this.p.data.length,this.p.data.push(E),E={})}!0!==this.p.altRows||u||("last"===c?1===(this.rows.length-
...
c.rows[b].id,l,d,b,e))||(f={}));0<a("input.hasDatepicker",g).length&&a("input.hasDatepicker",g).datepicker("hide");if("remote"===c.p.cellsubmit)if(c.p.cellurl){var u={};c.p.autoencode&&(d=a.jgrid.htmlEncode(d));u[l]=d;r=c.p.prmNames;k=r.id;p=r.oper;u[k]=a.jgrid.stripPref(c.p.idPrefix,c.rows[b].id);u[p]=r.editoper;u=a.extend(f,u);a(c).jqGrid("progressBar",{method:"show",loadtype:c.p.loadui,htmlcontent:a.jgrid.defaults.savetext||"Saving..."});c.grid.hDiv.loading=!0;a.ajax(a.extend({url:c.p.cellurl,
data:a.isFunction(c.p.serializeCellData)?c.p.serializeCellData.call(c,u):u,type:"POST",complete:function(f,k){a(c).jqGrid("progressBar",{method:"hide",loadtype:c.p.loadui});c.grid.hDiv.loading=!1;if("success"===k){var n=a(c).triggerHandler("jqGridAfterSubmitCell",[c,f,u.id,l,d,b,e])||[!0,""];!0===n[0]&&a.isFunction(c.p.afterSubmitCell)&&(n=c.p.afterSubmitCell.call(c,f,u.id,l,d,b,e));!0===n[0]?(a(g).empty(),a(c).jqGrid("setCell",c.rows[b].id,e,h,!1,!1,!0),a(g).addClass("dirty-cell"),a(c.rows[b]).addClass("edited"),
...
"move"),a.fn.jqDrag)a(k).jqDrag(m);else try{a(k).draggable({handle:a("#"+a.jgrid.jqID(m.id))})}catch(n){}if(c.resize)if(a.fn.jqResize)a(k).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"),a("#"+a.jgrid.jqID(b.themodal)).jqResize(".jqResize",b.scrollelm?"#"+a.jgrid.jqID(b.scrollelm):!1);else try{a(k).resizable({handles:"se, sw",alsoResize:b.scrollelm?"#"+a.jgrid.jqID(b.scrollelm):!1})}catch(u){}!0===c.closeOnEscape&&a(k).keydown(function(d){27===
...
e.custom_element.call(k,c,e))n=a(n).addClass("customelement").attr({id:e.id,name:e.name}),a(h).empty().append(n);else throw"e2";else throw"e1";}catch(u){"e1"===u&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===u?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof u?u:u.message,a.jgrid.edit.bClose)}}return h},
...
r)c[g]=f,m[g]=r,d++;else try{delete e.p.postData[g]}catch(q){}});var q=0<d?!0:!1;if(!0===b.stringResult||"local"===e.p.datatype||!0===b.searchOperators){var n='{"groupOp":"'+b.groupOp+'","rules":[',u=0;a.each(c,function(a,b){0<u&&(n+=",");n+='{"field":"'+a+'",';n+='"op":"'+m[a]+'",';n+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';u++});n+="]}";a.extend(e.p.postData,{filters:n});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,
...
l,p;p="";var m="=",r,q=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+e.p.direction+"'></th>"),n=a("<div style='position:relative;height:auto;padding-right:0.3em;padding-left:0.3em;'></div>"),u=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");!0===this.hidden&&a(q).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");
l=a.extend({},this.searchoptions||{});if(this.search){if(b.searchOperators){p=l.sopt?l.sopt[0]:"select"===k.stype?"eq":b.defaultSearch;for(r=0;r<b.odata.length;r++)if(b.odata[r].oper===p){m=b.operands[p]||"";break}p="<a title='"+(null!=l.searchtitle?l.searchtitle:b.operandTitle)+"' style='padding-right: 0.5em;' soper='"+p+"' class='soptclass' colname='"+this.name+"'>"+m+"</a>"}a("td:eq(0)",u).attr("colindex",f).append(p);void 0===l.clearSearch&&(l.clearSearch=!0);l.clearSearch?(p=b.resetTitle||"Clear Search Value",
a("td:eq(2)",u).append("<a title='"+p+"' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>"+b.resetIcon+"</a>")):a("td:eq(2)",u).hide();switch(this.stype){case "select":if(p=this.surl||l.dataUrl)a(n).append(u),a.ajax(a.extend({url:p,dataType:"html",success:function(d){void 0!==l.buildSelect?(d=l.buildSelect(d))&&a("td:eq(1)",u).append(d):a("td:eq(1)",u).append(d);void 0!==l.defaultValue&&a("select",n).val(l.defaultValue);a("select",n).attr({name:k.index||k.name,id:"gs_"+
k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);!0===b.autosearch&&a("select",n).change(function(){c();return!1});d=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var v,x,t;k.searchoptions?(v=void 0===k.searchoptions.value?"":k.searchoptions.value,x=void 0===k.searchoptions.separator?":":k.searchoptions.separator,t=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(v=void 0===k.editoptions.value?
"":k.editoptions.value,x=void 0===k.editoptions.separator?":":k.editoptions.separator,t=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(v){var y=document.createElement("select");y.style.width="100%";a(y).attr({name:k.index||k.name,id:"gs_"+k.name});var B;if("string"===typeof v)for(p=v.split(t),B=0;B<p.length;B++)v=p[B].split(x),t=document.createElement("option"),t.value=v[0],t.innerHTML=v[1],y.appendChild(t);else if("object"===typeof v)for(B in v)v.hasOwnProperty(B)&&(t=document.createElement("option"),
t.value=B,t.innerHTML=v[B],y.appendChild(t));void 0!==l.defaultValue&&a(y).val(l.defaultValue);l.attr&&a(y).attr(l.attr);a(n).append(u);a.jgrid.bindEv.call(e,y,l);a("td:eq(1)",u).append(y);!0===b.autosearch&&a(y).change(function(){c();return!1})}}break;case "text":x=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",u).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+x+"'/>");a(n).append(u);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,
a("input",n)[0],l);!0===b.autosearch&&(b.searchOnEnter?a("input",n).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(c(),!1):this}):a("input",n).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:d&&clearTimeout(d),d=setTimeout(function(){c()},b.autosearchDelay)}}));break;case "custom":a("td:eq(1)",u).append("<span style='width:95%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"'/>");a(n).append(u);try{if(a.isFunction(l.custom_element))if(y=
l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))y=a(y).addClass("customelement"),a(n).find("span[name='"+(k.index||k.name)+"']").append(y);else throw"e2";else throw"e1";}catch(w){"e1"===w&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===w?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===
typeof w?w:w.message,a.jgrid.edit.bClose)}}}a(q).append(n);a(g).append(q);b.searchOperators||a("td:eq(0)",u).hide()});a("table thead",e.grid.hDiv).append(g);b.searchOperators&&(a(".soptclass",g).click(function(b){var c=a(this).offset();f(this,c.left,c.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&a("#sopt_menu").hide()}));a(".clearsearchclass",g).click(function(d){d=a(this).parents("tr:first");var f=parseInt(a("td.ui-search-oper",d).attr("colindex"),
...
"searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,d);var n;e.p.searchurl&&(n=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var u="stop"===a(e).triggerHandler("jqGridToolbarBeforeClear")?!0:!1;!u&&a.isFunction(b.beforeClear)&&(u=b.beforeClear.call(e));u||c&&a(e).jqGrid("setGridParam",{search:m}).trigger("reloadGrid",[{page:1}]);n&&a(e).jqGrid("setGridParam",{url:n});a(e).triggerHandler("jqGridToolbarAfterClear");a.isFunction(b.afterClear)&&
...
var w=a("<td class='columns'></td>");h.append(w);var I=a("<select></select>"),C,E=[];w.append(I);I.bind("change",function(){b.field=a(I).val();x=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){t=d.p.columns[g];break}if(t){t.searchoptions.id=a.jgrid.randId();k&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=10);var c=a.jgrid.createEl.call(e,t.inputtype,t.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
t.searchoptions.sopt?t.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(t.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",h=0;E=[];a.each(d.p.ops,function(){E.push(this.oper)});for(g=0;g<l.length;g++)C=a.inArray(l[g],E),-1!==C&&(0===h&&(b.op=d.p.ops[C].oper),f+="<option value='"+d.p.ops[C].oper+"'>"+d.p.ops[C].text+"</option>",h++);a(".selectopts",x).empty().append(f);a(".selectopts",x)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",x)[0].offsetWidth,
...
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var D=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&B||B&&!D)B="",b.field===d.p.columns[g].name&&(B=" selected='selected'",w=g),y+="<option value='"+d.p.columns[g].name+"'"+B+">"+d.p.columns[g].label+"</option>"}I.append(y);y=a("<td class='operators'></td>");h.append(y);t=f.columns[w];t.searchoptions.id=a.jgrid.randId();k&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=10);w=a.jgrid.createEl.call(e,
t.inputtype,t.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(w).attr("readonly","true"),a(w).attr("disabled","true");var G=a("<select class='selectopts'></select>");y.append(G);G.bind("change",function(){b.op=a(G).val();x=a(this).parents("tr:first");var c=a(".input-elm",x)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=t.searchoptions.sopt?t.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(t.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;y="";a.each(d.p.ops,function(){E.push(this.oper)});for(g=0;g<l.length;g++)C=a.inArray(l[g],E),-1!==C&&(B=b.op===d.p.ops[C].oper?" selected='selected'":"",y+="<option value='"+d.p.ops[C].oper+"'"+B+">"+d.p.ops[C].text+"</option>");G.append(y);y=a("<td class='data'></td>");h.append(y);
...
p;"string"===typeof l&&(l=a.jgrid.parse(l));!0===b.recreateFilter&&a("#"+a.jgrid.jqID(k.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(k.themodal))[0])c(a("#fbox_"+a.jgrid.jqID(+f.p.id)));else{var m=a("<div><div id='"+g+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+a.jgrid.jqID(f.p.id)),r="left",q="";"rtl"===f.p.direction&&(r="right",q=" style='text-align:left'",m.attr("dir","rtl"));var n=a.extend([],f.p.colModel),u="<a id='"+g+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+
b.Find+"</a>",v="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",x="",t="",y,B=!1,w=-1;b.showQuery&&(x="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,w=0,y=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!B){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)B=!0,y=b.index||b.name,w=a}});if(!l&&y||!1===b.multipleSearch){var I="eq";0<=w&&n[w].searchoptions&&n[w].searchoptions.sopt?I=n[w].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(I=b.sopt[0]);l={groupOp:"AND",rules:[{field:y,op:I,data:""}]}}B=!1;b.tmplNames&&b.tmplNames.length&&(B=!0,t=b.tmplLabel,t+="<select class='ui-template'>",t+="<option value='default'>Default</option>",a.each(b.tmplNames,
function(a,b){t+="<option value='"+a+"'>"+b+"</option>"}),t+="</select>");r="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+g+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+r+"'>"+v+t+"</td><td class='EditButton' "+q+">"+x+u+"</td></tr></tbody></table>";g=a.jgrid.jqID(g);a("#"+g).jqFilter({columns:n,filter:b.loadDefaults?l:null,showQuery:b.showQuery,errorcheck:b.errorcheck,sopt:b.sopt,
groupButton:b.multipleGroup,ruleButtons:b.multipleSearch,afterRedraw:b.afterRedraw,ops:b.odata,operands:b.operands,ajaxSelectOptions:f.p.ajaxSelectOptions,groupOps:b.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(b.afterChange)&&b.afterChange.call(f,a("#"+g),b)},direction:f.p.direction,id:f.p.id});m.append(r);B&&b.tmplFilters&&b.tmplFilters.length&&a(".ui-template",m).bind("change",function(){var c=a(this).val();"default"===c?a("#"+g).jqFilter("addFilter",
...
break;case "password":case "text":case "textarea":case "button":z[this.name]=a(this).val()}n.p.autoencode&&(z[this.name]=a.jgrid.htmlEncode(z[this.name]))}});return!0}function g(c,d,e,f){var g,h,k,l=0,m,p,q,r=[],t=!1,u="",w;for(w=1;w<=f;w++)u+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==c&&(t=a(d).jqGrid("getInd",c));a(d.p.colModel).each(function(w){g=this.name;p=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===t)m="";else if(g===d.p.ExpandColumn&&!0===d.p.treeGrid)m=a("td[role='gridcell']:eq("+w+")",d.rows[t]).text();else{try{m=a.unformat.call(d,a("td[role='gridcell']:eq("+w+")",d.rows[t]),{rowId:c,colModel:this},w)}catch(y){m=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+w+")",d.rows[t]).text():a("td[role='gridcell']:eq("+w+")",d.rows[t]).html()}if(!m||"&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m=
""}var E=a.extend({},this.editoptions||{},{id:g,name:g,rowId:c}),x=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),B=parseInt(x.rowpos,10)||l+1,D=parseInt(2*(parseInt(x.colpos,10)||1),10);"_empty"===c&&E.defaultValue&&(m=a.isFunction(E.defaultValue)?E.defaultValue.call(n):E.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,E,m,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[g]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+B+"]");if(x.rowabove){var z=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+x.rowcontent+"</td></tr>");a(e).append(z);z[0].rp=B}0===k.length&&(k=a("<tr "+p+" rowpos='"+B+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(k).append(u),a(e).append(k),
k[0].rp=B);a("td:eq("+(D-2)+")",k[0]).html(void 0===x.label?d.p.colNames[w]:x.label);a("td:eq("+(D-1)+")",k[0]).append(x.elmprefix).append(q).append(x.elmsuffix);"custom"===this.edittype&&a.isFunction(E.custom_value)&&E.custom_value.call(n,a("#"+g,"#"+v),"set",m);a.jgrid.bindEv.call(n,q,E);r[l]=w;l++}});0<l&&(w=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
c+"'/></td></tr>"),w[0].rp=l+999,a(e).append(w),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[d.p.id+"_id"]=c);return r}function d(c,d,e){var f,g=0,h,k,l,m,p;if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData={},b[n.p.id]._savedData[d.p.id+"_id"]=c;var q=d.p.colModel;if("_empty"===c)a(q).each(function(){f=this.name;l=a.extend({},this.editoptions||{});(k=a("#"+a.jgrid.jqID(f),"#"+e))&&k.length&&null!==k[0]&&(m="","custom"===this.edittype&&a.isFunction(l.custom_value)?
...
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",t).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&z.hasOwnProperty(b.name)&&""===z[b.name]&&(z[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,w=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+v),A]);w&&"object"===typeof w&&(z=w);a.isFunction(b[n.p.id].beforeCheckValues)&&(w=b[n.p.id].beforeCheckValues.call(n,
z,a("#"+v),A))&&"object"===typeof w&&(z=w);for(p in z)if(z.hasOwnProperty(p)&&(f=a.jgrid.checkValues.call(n,z[p],p),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],z,A]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],z,A)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[z,a("#"+v),A]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,z,a("#"+v),A)));
if(f[0]&&!b[n.p.id].processing){b[n.p.id].processing=!0;a("#sData",t+"_2").addClass("ui-state-active");p=b[n.p.id].url||a(n).jqGrid("getGridParam","editurl");m=k.oper;l="clientArray"===p?n.p.keyName:k.id;z[m]="_empty"===a.trim(z[n.p.id+"_id"])?k.addoper:k.editoper;z[m]!==k.addoper?z[l]=z[n.p.id+"_id"]:void 0===z[l]&&(z[l]=z[n.p.id+"_id"]);delete z[n.p.id+"_id"];z=a.extend(z,b[n.p.id].editData,g);if(!0===n.p.treeGrid)for(r in z[m]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),z["adjacency"===
n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&(g=n.p.treeReader[r],!z.hasOwnProperty(g)||z[m]===k.addoper&&"parent_id_field"===r||delete z[g]);z[l]=a.jgrid.stripPref(n.p.idPrefix,z[l]);r=a.extend({url:p,type:b[n.p.id].mtype,data:a.isFunction(b[n.p.id].serializeEditData)?b[n.p.id].serializeEditData.call(n,z):z,complete:function(g,h){var p;a("#sData",t+"_2").removeClass("ui-state-active");z[l]=n.p.idPrefix+z[l];300<=g.status&&304!==
g.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[g,A]),a.isFunction(b[n.p.id].errorTextFormat)?f[1]=b[n.p.id].errorTextFormat.call(n,g,A):f[1]=h+" Status: '"+g.statusText+"'. Error code: "+g.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[g,z,A]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,g,z,A)));if(!1===f[0])a("#FormError>td",t).html(f[1]),a("#FormError",t).show();else if(n.p.autoencode&&a.each(z,function(b,
c){z[b]=a.jgrid.htmlDecode(c)}),z[m]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==z[l]?z[l]=f[2]:f[2]=z[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,z):a(n).jqGrid("addRowData",f[2],z,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,
form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,v)):(b[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",z[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",z[l],z):a(n).jqGrid("setRowData",z[l],z),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,
form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=g,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[e,z,a("#"+v),A]);b[n.p.id].afterComplete.call(n,e,z,a("#"+v),A);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a("#"+v).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(p in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(p)&&z[p]&&(b[n.p.id]._savedData[p]=z[p]);b[n.p.id].processing=!1;try{a(":input:visible","#"+
v)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,b[n.p.id].ajaxEditOptions);r.url||b[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?b[n.p.id].useDataProxy=!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));f[0]&&(b[n.p.id].useDataProxy?(g=n.p.dataProxy.call(n,r,"set_"+n.p.id),void 0===g&&(g=[!0,""]),!1===g[0]?(f[0]=!1,f[1]=g[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&b[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,
onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}),r.data.oper===k.editoper&&b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}))):"clientArray"===r.url?(b[n.p.id].reloadAfterSubmit=!1,z=r.data,r.complete({status:200,statusText:""},"")):a.ajax(r))}!1===f[0]&&
(a("#FormError>td",t).html(f[1]),a("#FormError",t).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function p(){var c=!0;a("#FormError",t).hide();b[n.p.id].checkOnUpdate&&(z={},f(),P=l(z,b[n.p.id]._savedData))&&(a("#"+v).data("disabled",!0),a(".confirm","#"+y.themodal).show(),c=!1);return c}function m(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<n.p.savedRow.length;b++)if(n.p.savedRow[b].id==
e){a(n).jqGrid("restoreRow",e);break}}function r(b,c){var d=c[1].length-1;0===b?a("#pData",t+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?a("#pData",t+"_2").addClass("ui-state-disabled"):a("#pData",t+"_2").removeClass("ui-state-disabled");b===d?a("#nData",t+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",t+"_2").addClass("ui-state-disabled"):a("#nData",
t+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",t).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var u=n.p.id,v="FrmGrid_"+u,x="TblGrid_"+u,t="#"+a.jgrid.jqID(x),y={themodal:"editmod"+u,modalhead:"edithd"+u,modalcontent:"editcnt"+u,scrollelm:v},B=a.isFunction(b[n.p.id].beforeShowForm)?b[n.p.id].beforeShowForm:!1,w=a.isFunction(b[n.p.id].afterShowForm)?b[n.p.id].afterShowForm:!1,I=a.isFunction(b[n.p.id].beforeInitData)?b[n.p.id].beforeInitData:
!1,C=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,E=!0,D=1,G=0,z,P,A,v=a.jgrid.jqID(v);"new"===e?(e="_empty",A="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,A="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var M=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(M=!1);var R=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",E=isNaN(b[a(this)[0].p.id].datawidth)?
b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",R=a("<form name='FormPost' id='"+v+"' class='FormGrid' onSubmit='return false;' style='width:"+E+";overflow:auto;position:relative;height:"+R+";'></form>").data("disabled",!1),W=a("<table id='"+x+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;D=Math.max(D,a?a.colpos||0:0);G=Math.max(G,a?a.rowpos||0:0)});a(R).append(W);E=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
2*D+"'></td></tr>");E[0].rp=0;a(W).append(E);E=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*D+"'>"+b[n.p.id].topinfo+"</td></tr>");E[0].rp=0;a(W).append(E);E=a(n).triggerHandler("jqGridAddEditBeforeInitData",[R,A]);void 0===E&&(E=!0);E&&I&&(E=I.call(n,R,A));if(!1!==E){m();var E=(I="rtl"===n.p.direction?!0:!1)?"nData":"pData",Y=I?"pData":"nData";g(e,n,W,D);var E="<a id='"+E+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
Y="<a id='"+Y+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",F="<a id='sData' class='fm-button ui-state-default ui-corner-all'>"+c.bSubmit+"</a>",ca="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bCancel+"</a>",x="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+x+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
(I?Y+E:E+Y)+"</td><td class='EditButton'>"+F+ca+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),x=x+"</tbody></table>";if(0<G){var U=[];a.each(a(W)[0].rows,function(a,b){U[a]=b});U.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(U,function(b,c){a("tbody",W).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(u);var N=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,N=!0);x=a("<div></div>").append(R).append(x);a.jgrid.createModal(y,
x,b[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);I&&(a("#pData, #nData",t+"_2").css("float","right"),a(".EditButton",t+"_2").css("text-align","left"));b[n.p.id].topinfo&&a(".tinfo",t).show();b[n.p.id].bottominfo&&a(".binfo",t+"_2").show();x=x=null;a("#"+a.jgrid.jqID(y.themodal)).keydown(function(d){var e=d.target;if(!0===a("#"+v).data("disabled"))return!1;if(!0===b[n.p.id].savekey[0]&&d.which===b[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
t+"_2").trigger("click"),!1;if(27===d.which){if(!p())return!1;N&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}if(!0===b[n.p.id].navkeys[0]){if("_empty"===a("#id_g",t).val())return!0;if(d.which===b[n.p.id].navkeys[1])return a("#pData",t+"_2").trigger("click"),!1;if(d.which===b[n.p.id].navkeys[2])return a("#nData",t+"_2").trigger("click"),!1}});c.checkOnUpdate&&
(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(y.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(y.themodal)).unbind("click").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}));c.saveicon=a.extend([!0,"left","ui-icon-disk"],c.saveicon);c.closeicon=a.extend([!0,
"left","ui-icon-close"],c.closeicon);!0===c.saveicon[0]&&a("#sData",t+"_2").addClass("right"===c.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.saveicon[2]+"'></span>");!0===c.closeicon[0]&&a("#cData",t+"_2").addClass("right"===c.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.closeicon[2]+"'></span>");if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)F="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
c.bYes+"</a>",Y="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bNo+"</a>",ca="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",x=c.zIndex||999,x++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+x+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(x+1)+"'>"+c.saveData+"<br/><br/>"+F+Y+ca+"</div>").insertAfter("#"+v),a("#sNew","#"+a.jgrid.jqID(y.themodal)).click(function(){k();
a("#"+v).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();return!1}),a("#nNew","#"+a.jgrid.jqID(y.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();a("#"+v).data("disabled",!1);setTimeout(function(){a(":input:visible","#"+v)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(y.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();a("#"+v).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),
jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+v),A]);C&&C.call(n,a("#"+v),A);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",t+"_2").show():a("#pData,#nData",t+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+v),A]);B&&B.call(n,a("#"+v),A);a("#"+a.jgrid.jqID(y.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
a.jgrid.jqID(y.themodal),{gbox:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,overlay:c.overlay,modal:c.modal,overlayClass:c.overlayClass,onHide:function(b){var c=a("#editmod"+u)[0].style.height;-1<c.indexOf("px")&&(c=parseFloat(c));a(n).data("formProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:c,dataheight:a("#"+v).height(),datawidth:a("#"+v).width()});b.w.remove();b.o&&b.o.remove()}});M||a("."+a.jgrid.jqID(c.overlayClass)).click(function(){if(!p())return!1;
a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(".fm-button","#"+a.jgrid.jqID(y.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",t+"_2").click(function(){z={};a("#FormError",t).hide();f();"_empty"===z[n.p.id+"_id"]?k():!0===c.checkOnSubmit?(P=l(z,b[n.p.id]._savedData))?
(a("#"+v).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(y.themodal)).show()):k():k();return!1});a("#cData",t+"_2").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(u),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a("#nData",t+"_2").click(function(){if(!p())return!1;a("#FormError",t).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+
1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+v),b[1][b[0]]]);var e;if(a.isFunction(c.onclickPgButtons)&&(e=c.onclickPgButtons.call(n,"next",a("#"+v),b[1][b[0]]),void 0!==e&&!1===e)||a("#"+a.jgrid.jqID(b[1][b[0]+1])).hasClass("ui-state-disabled"))return!1;d(b[1][b[0]+1],n,v);a(n).jqGrid("setSelection",b[1][b[0]+1]);a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+v),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&c.afterclickPgButtons.call(n,"next",a("#"+
v),b[1][b[0]+1]);r(b[0]+1,b)}return!1});a("#pData",t+"_2").click(function(){if(!p())return!1;a("#FormError",t).hide();var b=q();if(-1!==b[0]&&b[1][b[0]-1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+v),b[1][b[0]]]);var e;if(a.isFunction(c.onclickPgButtons)&&(e=c.onclickPgButtons.call(n,"prev",a("#"+v),b[1][b[0]]),void 0!==e&&!1===e)||a("#"+a.jgrid.jqID(b[1][b[0]-1])).hasClass("ui-state-disabled"))return!1;d(b[1][b[0]-1],n,v);a(n).jqGrid("setSelection",b[1][b[0]-1]);a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",
["prev",a("#"+v),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&c.afterclickPgButtons.call(n,"prev",a("#"+v),b[1][b[0]-1]);r(b[0]-1,b)}return!1});a(n).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+v),A]);w&&w.call(n,a("#"+v),A);B=q();r(B[0],B)}}})},viewGridRow:function(e,c){c=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,
beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},a.jgrid.view,c||{});b[a(this)[0].p.id]=c;return this.each(function(){function f(){!0!==b[l.p.id].closeOnEscape&&!0!==b[l.p.id].navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(u.modalhead)).attr("tabindex","-1").focus()},0)}function g(b,d,e,f){var g,h,k,l=0,n,m,p=[],q=!1,r,t="<td class='CaptionTD form-view-label ui-widget-content' width='"+c.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
u="",v=["integer","number","currency"],w=0,y=0,x,B,C;for(r=1;r<=f;r++)u+=1===r?t:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,v)?w=Math.max(w,parseInt(this.width,10)):y=Math.max(y,parseInt(this.width,10)))});x=0!==w?w:0!==y?y:0;q=a(d).jqGrid("getInd",
b);a(d.p.colModel).each(function(b){g=this.name;B=!1;m=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";C="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&C){n=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();B="right"===this.align&&0!==x?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||
l+1,t=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var w=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(w);w[0].rp=r}k=a(e).find("tr[rowpos="+r+"]");0===k.length&&(k=a("<tr "+m+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(k).append(u),a(e).append(k),k[0].rp=r);a("td:eq("+(t-2)+")",k[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(t-1)+")",k[0]).append("<span>"+n+"</span>").attr("id","v_"+g);
B&&a("td:eq("+(t-1)+") span",k[0]).css({"text-align":"right",width:x+"px"});p[l]=b;l++}});0<l&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=l+99,a(e).append(b));return p}function d(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?
...
p,n="ViewTbl_"+p,u={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,scrollelm:m},v=a.isFunction(b[l.p.id].beforeInitData)?b[l.p.id].beforeInitData:!1,x=!0,t=1,y=0;c.recreateForm||a(l).data("viewProp")&&a.extend(b[a(this)[0].p.id],a(l).data("viewProp"));var B=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",w=isNaN(b[a(this)[0].p.id].datawidth)?b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
q+"' class='FormGrid' style='width:"+w+";overflow:auto;position:relative;height:"+B+";'></form>"),I=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(l.p.colModel).each(function(){var a=this.formoptions;t=Math.max(t,a?a.colpos||0:0);y=Math.max(y,a?a.rowpos||0:0)});a(q).append(I);v&&(x=v.call(l,q),void 0===x&&(x=!0));if(!1!==x){g(e,l,I,t);n="rtl"===l.p.direction?!0:!1;v="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
x="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";B="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bClose+"</a>";if(0<y){var C=[];a.each(a(I)[0].rows,function(a,b){C[a]=b});C.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(C,function(b,c){a("tbody",I).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(p);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+
r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+c.labelswidth+"'>"+(n?x+v:v+x)+"</td><td class='EditButton'>"+B+"</td></tr></tbody></table>");a.jgrid.createModal(u,q,c,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData","#"+r+"_2").css("float","right"),a(".EditButton","#"+r+"_2").css("text-align","left"));c.viewPagerButtons||a("#pData, #nData","#"+r+"_2").hide();q=null;a("#"+u.themodal).keydown(function(d){if(27===d.which)return b[l.p.id].closeOnEscape&&
...
jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,c||{});b[a(this)[0].p.id]=c;return this.each(function(){var f=this;if(f.grid&&e){var g=a.isFunction(b[f.p.id].beforeShowForm),d=a.isFunction(b[f.p.id].afterShowForm),h=a.isFunction(b[f.p.id].beforeInitData)?b[f.p.id].beforeInitData:!1,k=f.p.id,l={},p=!0,m="DelTbl_"+a.jgrid.jqID(k),r,q,n,u,v="DelTbl_"+k,x={themodal:"delmod"+k,modalhead:"delhd"+
k,modalcontent:"delcnt"+k,scrollelm:m};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(x.themodal))[0]){h&&(p=h.call(f,a("#"+m)),void 0===p&&(p=!0));if(!1===p)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();!0===b[f.p.id].processing&&(b[f.p.id].processing=!1,a("#dData","#"+m).removeClass("ui-state-active"));g&&b[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(x.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b[f.p.id].jqModal,jqM:!1,overlay:b[f.p.id].overlay,
...
b[f.p.id].msg+"</td></tr><tr><td >&#160;</td></tr>"),v=v+"</tbody></table></div>",v=v+("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+("<a id='dData' class='fm-button ui-state-default ui-corner-all'>"+c.bSubmit+"</a>")+"&#160;"+("<a id='eData' class='fm-button ui-state-default ui-corner-all'>"+c.bCancel+"</a>")+"</td></tr></tbody></table>");c.gbox="#gbox_"+
a.jgrid.jqID(k);a.jgrid.createModal(x,v,c,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);h&&(p=h.call(f,a(v)),void 0===p&&(p=!0));if(!1===p)return;a(".fm-button","#"+m+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});c.delicon=a.extend([!0,"left","ui-icon-scissors"],b[f.p.id].delicon);c.cancelicon=a.extend([!0,"left","ui-icon-cancel"],b[f.p.id].cancelicon);!0===c.delicon[0]&&a("#dData","#"+m+"_2").addClass("right"===
...
a("#DelError","#"+m).show());return!1});a("#eData","#"+m+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b[f.p.id].jqModal,onClose:b[f.p.id].onClose});return!1});g&&b[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(x.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b[f.p.id].jqModal,overlay:b[f.p.id].overlay,modal:b[f.p.id].modal})}d&&b[f.p.id].afterShowForm.call(f,a("#"+m));!0===b[f.p.id].closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close",
"#"+a.jgrid.jqID(x.modalhead)).attr("tabindex","-1").focus()},0)}})},navGrid:function(b,c,f,g,d,h,k){c=a.extend({edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",del:!0,delicon:"ui-icon-trash",search:!0,searchicon:"ui-icon-search",refresh:!0,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:!1,viewicon:"ui-icon-document",position:"left",closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,alertwidth:200,alertheight:"auto",alerttop:null,alertleft:null,alertzIndex:null},
...
a.jgrid.jqID(p.p.id),a("#gbox_"+a.jgrid.jqID(p.p.id))[0],!0));var r=1,q,n=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},u=function(){a(this).removeClass("ui-state-hover")};c.cloneToTop&&p.p.toppager&&(r=2);for(q=0;q<r;q++){var v=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),x,t;0===q?(x=b,t=p.p.id,x===p.p.toppager&&(t+="_top",r=1)):(x=p.p.toppager,t=
p.p.id+"_top");"rtl"===p.p.direction&&a(v).attr("dir","rtl").css("float","right");c.add&&(g=g||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.addicon+"'></span>"+c.addtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.addtitle||"",id:g.id||"add_"+t}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(c.addfunc)?c.addfunc.call(p):a(p).jqGrid("editGridRow","new",g));return!1}).hover(n,u),m=null);c.edit&&(m=
a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.editicon+"'></span>"+c.edittext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.edittitle||"",id:f.id||"edit_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b=p.p.selrow;b?a.isFunction(c.editfunc)?c.editfunc.call(p,b):a(p).jqGrid("editGridRow",b,f):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,
u),m=null);c.view&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),k=k||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.viewicon+"'></span>"+c.viewtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.viewtitle||"",id:k.id||"view_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b=p.p.selrow;b?a.isFunction(c.viewfunc)?c.viewfunc.call(p,b):a(p).jqGrid("viewGridRow",b,k):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,
u),m=null);c.del&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),d=d||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.delicon+"'></span>"+c.deltext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.deltitle||"",id:d.id||"del_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b;p.p.multiselect?(b=p.p.selarrrow,0===b.length&&(b=null)):b=p.p.selrow;b?a.isFunction(c.delfunc)?c.delfunc.call(p,b):a(p).jqGrid("delGridRow",b,d):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+
a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,u),m=null);(c.add||c.edit||c.del||c.view)&&a("tr",v).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");c.search&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.searchicon+"'></span>"+c.searchtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.searchtitle||"",id:h.id||"search_"+t}).click(function(){a(this).hasClass("ui-state-disabled")||
(a.isFunction(c.searchfunc)?c.searchfunc.call(p,h):a(p).jqGrid("searchGrid",h));return!1}).hover(n,u),h.showOnLoad&&!0===h.showOnLoad&&a(m,v).click(),m=null);c.refresh&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.refreshicon+"'></span>"+c.refreshtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.refreshtitle||"",id:"refresh_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(c.beforeRefresh)&&c.beforeRefresh.call(p);
p.p.search=!1;p.p.resetsearch=!0;try{if("currentfilter"!==c.refreshstate){var b=p.p.id;p.p.postData.filters="";try{a("#fbox_"+a.jgrid.jqID(b)).jqFilter("resetFilter")}catch(d){}a.isFunction(p.clearToolbar)&&p.clearToolbar.call(p,!1)}}catch(e){}switch(c.refreshstate){case "firstpage":a(p).trigger("reloadGrid",[{page:1}]);break;case "current":case "currentfilter":a(p).trigger("reloadGrid",[{current:!0}])}a.isFunction(c.afterRefresh)&&c.afterRefresh.call(p)}return!1}).hover(n,u),m=null);m=a(".ui-jqgrid").css("font-size")||
"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+m+";visibility:hidden;' ></div>");m=a(v).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(x+"_"+c.position,x).append(v);p.p._nvtd&&(m>p.p._nvtd[0]&&(a(x+"_"+c.position,x).width(m),p.p._nvtd[0]=m),p.p._nvtd[1]=m);v=m=m=null;this.nav=!0}}}})},navButtonAdd:function(b,c){c=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},
...
"<td "+h.formatCol(p,1,"")+">"+a.jgrid.format(r,n)+"</td>";return!1}});b+=q}return b}var h=this,k=h.p.groupingView,l="",p="",m,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,u=[],v=k.groupField.length,q=q+(" tree-wrap-"+h.p.direction);a.each(h.p.colModel,function(a,b){var c;for(c=0;c<v;c++)if(k.groupField[c]===b.name){u[c]=a;break}});var x=0,t=a.makeArray(k.groupSummary),y;t.reverse();y=h.p.multiselect?' colspan="2"':"";a.each(k.groups,function(g,w){if(k._locgr&&!(w.startRow+w.cnt>(c-1)*f&&w.startRow<
c*f))return!0;x++;r=h.p.id+"ghead_"+w.idx;m=r+"_"+g;p="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(h.p.id)+"').jqGrid('groupingToggle','"+m+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&a.isFunction(k.formatDisplayField[w.idx])?(w.displayValue=k.formatDisplayField[w.idx].call(h,w.displayValue,w.value,h.p.colModel[u[w.idx]],w.idx,k),n=w.displayValue):n=h.formatter(m,w.displayValue,u[w.idx],w.value)}catch(I){n=w.displayValue}"header"===k.groupSummaryPos[w.idx]?
(l+='<tr id="'+m+'"'+(k.groupCollapse&&0<w.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*w.idx+'px;"'+y+">"+p+a.jgrid.template(k.groupText[w.idx],n,w.cnt,w.summary)+"</td>",l+=d(g,0,k.groups,!1===k.groupColumnShow[w.idx]?""===y?2:3:""===y?1:2),l+="</tr>"):l+='<tr id="'+m+'"'+(k.groupCollapse&&0<w.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+
r+'"><td style="padding-left:'+12*w.idx+'px;" colspan="'+(!1===k.groupColumnShow[w.idx]?e-1:e)+'">'+p+a.jgrid.template(k.groupText[w.idx],n,w.cnt,w.summary)+"</td></tr>";if(v-1===w.idx){var C=k.groups[g+1],E,D=0;E=w.startRow;var G=void 0!==C?C.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(D=(c-1)*f,D>w.startRow&&(E=D));for(;E<G&&b[E-D];E++)l+=b[E-D].join("");if("header"!==k.groupSummaryPos[w.idx]){var z;if(void 0!==C){for(z=0;z<k.groupField.length&&C.dataIndex!==k.groupField[z];z++);x=
k.groupField.length-z}for(C=0;C<x;C++)t[C]&&(D="",k.groupCollapse&&!k.showSummaryOnHide&&(D=' style="display:none;"'),l+="<tr"+D+' jqfootlevel="'+(w.idx-C)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,C,k.groups,0),l+="</tr>");x=z}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&
...
d===c.p.ExpandColumn;if(l)e=a("span:first",this).html();else try{e=a.unformat.call(c,this,{rowId:b,colModel:m[f]},f)}catch(p){e=m[f].edittype&&"textarea"===m[f].edittype?a(this).text():a(this).html()}if("cb"!==d&&"subgrid"!==d&&"rn"!==d&&(c.p.autoencode&&(e=a.jgrid.htmlDecode(e)),k[d]=e,!0===m[f].editable)){null===h&&(h=f);l?a("span:first",this).html(""):a(this).html("");var u=a.extend({},m[f].editoptions||{},{id:b+"_"+d,name:d,rowId:b});m[f].edittype||(m[f].edittype="text");if("&nbsp;"===e||"&#160;"===
e||1===e.length&&160===e.charCodeAt(0))e="";var y=a.jgrid.createEl.call(c,m[f].edittype,u,e,!0,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));a(y).addClass("editable");l?a("span:first",this).append(y):a(this).append(y);a.jgrid.bindEv.call(c,y,u);"select"===m[f].edittype&&void 0!==m[f].editoptions&&!0===m[f].editoptions.multiple&&void 0===m[f].editoptions.dataUrl&&a.jgrid.msie&&a(y).width(a(y).width());g++}}),0<g&&(k.id=b,c.p.savedRow.push(k),a(l).attr("editable","1"),p.focusField&&("number"===
...
afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",saveui:"enable",savetext:a.jgrid.defaults.savetext||"Saving..."},a.jgrid.inlineEdit,l),p=!1,m=this[0],r,q={},n={},u={},v,x,t;if(!m.grid)return p;t=a(m).jqGrid("getInd",b,!0);if(!1===t)return p;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(m,l,b):void 0;void 0===k&&(k=!0);if(k){k=a(t).attr("editable");l.url=l.url||m.p.editurl;if("1"===k){var y;a('td[role="gridcell"]',t).each(function(b){y=m.p.colModel[b];r=y.name;if("cb"!==r&&"subgrid"!==
...
n[r]=d.join(",")}else q[r]=a("select option:selected",this).val(),n[r]=a("select option:selected",this).text();y.formatter&&"select"===y.formatter&&(n={});break;case "custom":try{if(y.editoptions&&a.isFunction(y.editoptions.custom_value)){if(q[r]=y.editoptions.custom_value.call(m,a(".customelement",this),"get"),void 0===q[r])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}x=a.jgrid.checkValues.call(m,q[r],b);if(!1===x[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&y.editoptions&&!0===y.editoptions.NullIfEmpty&&""===q[r]&&(u[r]="null")}});if(!1===x[0]){try{var B=a(m).jqGrid("getGridRowById",b),w=a.jgrid.findPos(B);a.jgrid.info_dialog(a.jgrid.errors.errcap,x[1],a.jgrid.edit.bClose,{left:w[0],
top:w[1]+a(B).outerHeight()})}catch(I){alert(x[1])}return p}k=m.p.prmNames;B=b;w=!1===m.p.keyName?k.id:m.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[w]||""===q[w]?q[w]=b:t.id!==m.p.idPrefix+q[w]&&(k=a.jgrid.stripPref(m.p.idPrefix,b),void 0!==m.p._index[k]&&(m.p._index[q[w]]=m.p._index[k],delete m.p._index[k]),b=m.p.idPrefix+q[w],a(t).attr("id",b),m.p.selrow===B&&(m.p.selrow=b),a.isArray(m.p.selarrrow)&&(k=a.inArray(B,m.p.selarrrow),0<=k&&(m.p.selarrrow[k]=b)),m.p.multiselect&&(k="jqg_"+m.p.id+"_"+
b,a("input.cbox",t).attr("id",k).attr("name",k))),void 0===m.p.inlineData&&(m.p.inlineData={}),q=a.extend({},q,m.p.inlineData,l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(m).jqGrid("setRowData",b,q);a(t).attr("editable","0");for(w=0;w<m.p.savedRow.length;w++)if(String(m.p.savedRow[w].id)===String(B)){v=w;break}0<=v&&m.p.savedRow.splice(v,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,k,q,l]);a.isFunction(l.aftersavefunc)&&
l.aftersavefunc.call(m,b,k,q,l);p=!0;a(t).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).jqGrid("progressBar",{method:"show",loadtype:l.saveui,htmlcontent:l.savetext}),u=a.extend({},q,u),u[w]=a.jgrid.stripPref(m.p.idPrefix,u[w]),a.ajax(a.extend({url:l.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,u):u,type:l.mtype,async:!1,complete:function(c,d){a(m).jqGrid("progressBar",{method:"hide",loadtype:l.saveui,htmlcontent:l.savetext});if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",
[c,b,l]);a.isArray(f)||(f=[!0,q]);f[0]&&a.isFunction(l.successfunc)&&(f=l.successfunc.call(m,c));a.isArray(f)?(e=f[0],q=f[1]||q):e=f;if(!0===e){m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});q=a.extend({},q,n);a(m).jqGrid("setRowData",b,q);a(t).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(String(m.p.savedRow[e].id)===String(b)){v=e;break}0<=v&&m.p.savedRow.splice(v,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,c,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(m,
b,c,q,l);p=!0;a(t).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,null,l]),a.isFunction(l.errorfunc)&&l.errorfunc.call(m,b,c,d,null),!0===l.restoreAfterError&&a(m).jqGrid("restoreRow",b,l.afterrestorefunc)}},error:function(c,d,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,e,l]);if(a.isFunction(l.errorfunc))l.errorfunc.call(m,b,c,d,e);else{c=c.responseText||c.statusText;try{a.jgrid.info_dialog(a.jgrid.errors.errcap,
...
b=a(b).closest("table.ui-jqgrid-btable");return 0<b.length&&void 0!==a.data(b[0],"dnd")?(b=a.data(b[0],"dnd").connectWith,-1!==a.inArray("#"+a.jgrid.jqID(this.id),b)?!0:!1):!1},drop:function(c,d){if(a(d.draggable).hasClass("jqgrow")){var e=a(d.draggable).attr("id"),e=d.draggable.parent().parent().jqGrid("getRowData",e);if(!b.dropbyname){var g=0,r={},q,n,u=a("#"+a.jgrid.jqID(this.id)).jqGrid("getGridParam","colModel");try{for(n in e)e.hasOwnProperty(n)&&(q=u[g].name,"cb"!==q&&"rn"!==q&&"subgrid"!==
q&&e.hasOwnProperty(n)&&u[g]&&(r[q]=e[n]),g++);e=r}catch(v){}}d.helper.dropped=!0;b.beforedrop&&a.isFunction(b.beforedrop)&&(q=b.beforedrop.call(this,c,d,e,a("#"+a.jgrid.jqID(f.p.id)),a(this)),void 0!==q&&null!==q&&"object"===typeof q&&(e=q));if(d.helper.dropped){var x;b.autoid&&(a.isFunction(b.autoid)?x=b.autoid.call(this,e):(x=Math.ceil(1E3*Math.random()),x=b.autoidprefix+x));a("#"+a.jgrid.jqID(this.id)).jqGrid("addRowData",x,e,b.droppos)}b.ondrop&&a.isFunction(b.ondrop)&&b.ondrop.call(this,c,d,
...
colTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1},c||{});this.each(function(){function c(a,d,e){a=b.call(a,d,e);return 0<a.length?a[0]:null}function q(a,b){var c=0,d=!0,e;for(e in a){if(a[e]!=this[c]){d=!1;break}c++;if(c>=this.length)break}d&&(x=b);return d}function n(b,c,d,e){var f=c.length,g,l,m,n,p="",q=[];a.isArray(d)?(n=d.length,q=d):(n=1,q[0]=d);h=[];k=[];for(m=h.root=0;m<n;m++){var r=[],t;for(g=0;g<f;g++){if(null==d)t=l=a.trim(c[g].member)+"_"+c[g].aggregator,q[0]=
t;else{t=d[m].replace(/\s+/g,"");try{l=1===f?p+t:p+t+"_"+c[g].aggregator+"_"+String(g)}catch(u){}}var v=l=isNaN(parseInt(l,10))?l:l+" ",w=r,y=l,x=e[l],z=c[g].member,B=b,A=void 0;switch(c[g].aggregator){case "sum":A=parseFloat(x||0)+parseFloat(B[z]||0);break;case "count":if(""===x||null==x)x=0;A=B.hasOwnProperty(z)?x+1:0;break;case "min":A=""===x||null==x?parseFloat(B[z]||0):Math.min(parseFloat(x),parseFloat(B[z]||0));break;case "max":A=""===x||null==x?parseFloat(B[z]||0):Math.max(parseFloat(x),parseFloat(B[z]||
0))}e[v]=w[y]=A;1>=m&&"_r_Totals"!==t&&""===p&&(p=t)}h[l]=r;k[l]=q[m]}return e}function u(a){var b,c,d,e,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==typeof a[d]){if("level"===d){void 0===R[a.level]&&(R[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(p[a.level-1]={useColSpanStyle:!1,groupHeaders:[]}));if(R[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level){p[a.level-1].groupHeaders.push({titleText:a.label,numberOfColumns:0});c=p[a.level-1].groupHeaders.length-1;g=0===c?Y:W+
I;if(a.level-1===(m.rowTotals?1:0)&&0<c){var h=p[a.level-1].groupHeaders[c-1].numberOfColumns;h&&(g=h+1+m.aggregates.length)}p[a.level-1].groupHeaders[c].startColumnName=f[g].name;p[a.level-1].groupHeaders[c].numberOfColumns=f.length-g;W=f.length}R[a.level]=a.text}if(a.level===w&&"level"===d&&0<w)if(1<I){c=1;for(b in a.fields)1===c&&p[w-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;p[w-1].groupHeaders[p[w-1].groupHeaders.length-1].numberOfColumns=c-1}else p.splice(w-
1,1)}null!=a[d]&&"object"===typeof a[d]&&u(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<I?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);f.push(g);c++}}}var v,x,t,y=e.length,B,w,I,C,E=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,
0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});B=a.isArray(m.xDimension)?m.xDimension.length:0;w=m.yDimension.length;I=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===B||0===I)throw"xDimension or aggregates optiona are not set!";var D;for(t=0;t<B;t++)D={name:m.xDimension[t].dataName,frozen:m.frozenStaticCols},null==m.xDimension[t].isGroupField&&(m.xDimension[t].isGroupField=!0),D=a.extend(!0,D,m.xDimension[t]),f.push(D);D=B-1;for(var G={};E<y;){v=
e[E];var z=[],P=[];C={};t=0;do z[t]=a.trim(v[m.xDimension[t].dataName]),C[m.xDimension[t].dataName]=z[t],t++;while(t<B);var A=0;x=-1;t=c(g,q,z);if(!t){A=0;if(1<=w){for(A=0;A<w;A++)P[A]=a.trim(v[m.yDimension[A].dataName]),m.yDimension[A].converter&&a.isFunction(m.yDimension[A].converter)&&(P[A]=m.yDimension[A].converter.call(this,P[A],z,P));C=n(v,m.aggregates,P,C)}else 0===w&&(C=n(v,m.aggregates,null,C));g.push(C)}else if(0<=x){A=0;if(1<=w){for(A=0;A<w;A++)P[A]=a.trim(v[m.yDimension[A].dataName]),
m.yDimension[A].converter&&a.isFunction(m.yDimension[A].converter)&&(P[A]=m.yDimension[A].converter.call(this,P[A],z,P));t=n(v,m.aggregates,P,t)}else 0===w&&(t=n(v,m.aggregates,null,t));g[x]=t}v=0;var z=C=null,M;for(M in h)if(h.hasOwnProperty(M)){if(0===v)G.children&&void 0!==G.children||(G={text:M,level:0,children:[],label:M}),C=G.children;else{z=null;for(t=0;t<C.length;t++)if(C[t].text===M){z=C[t];break}z?C=z.children:(C.push({children:[],text:M,level:v,fields:h[M],label:k[M]}),C=C[C.length-1].children)}v++}E++}var R=
[],W=f.length,Y=W;0<w&&(p[w-1]={useColSpanStyle:!1,groupHeaders:[]});u(G);if(m.colTotals)for(E=g.length;E--;)for(t=B;t<f.length;t++)y=f[t].name,d[y]=d[y]?d[y]+parseFloat(g[E][y]||0):parseFloat(g[E][y]||0);if(0<D)for(t=0;t<D;t++)f[t].isGroupField&&(l.groupingView.groupField.push(f[t].name),l.groupingView.groupSummary.push(m.groupSummary),l.groupingView.groupSummaryPos.push(m.groupSummaryPos));else l.grouping=!1;l.sortname=f[D].name;l.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:g,groupOptions:l,
...
url:a.isFunction(c.p.subGridUrl)?c.p.subGridUrl.call(c,f):c.p.subGridUrl,dataType:c.p.subgridtype,data:a.isFunction(c.p.serializeSubGridData)?c.p.serializeSubGridData.call(c,f):f,complete:function(b){"xml"===c.p.subgridtype?g(b.responseXML,e):d(a.jgrid.parse(b.responseText),e)}},a.jgrid.ajaxOptions,c.p.ajaxSubgridOptions||{}))}return!1},k,l,p,m=0,r,q;a.each(c.p.colModel,function(){!0!==this.hidden&&"rn"!==this.name&&"cb"!==this.name||m++});var n=c.rows.length,u=1;void 0!==e&&0<e&&(u=e,n=e+1);for(;u<
n;)a(c.rows[u]).hasClass("jqgrow")&&(c.p.scroll&&a(c.rows[u].cells[b]).unbind("click"),a(c.rows[u].cells[b]).bind("click",function(){var d=a(this).parent("tr")[0];q=d.nextSibling;if(a(this).hasClass("sgcollapsed")){l=c.p.id;k=d.id;if(!0===c.p.subGridOptions.reloadOnExpand||!1===c.p.subGridOptions.reloadOnExpand&&!a(q).hasClass("ui-subgrid")){p=1<=b?"<td colspan='"+b+"'>&#160;</td>":"";r=a(c).triggerHandler("jqGridSubGridBeforeExpand",[l+"_"+k,k]);(r=!1===r||"stop"===r?!1:!0)&&a.isFunction(c.p.subGridBeforeExpand)&&
...
if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][g]=parseInt(e[k][g],10)-h)}}})},addChildNode:function(b,e,c,f){var g=this[0];if(c){var d=g.p.treeReader.expanded_field,h=g.p.treeReader.leaf_field,k=g.p.treeReader.level_field,l=g.p.treeReader.parent_id_field,p=g.p.treeReader.left_field,m=g.p.treeReader.right_field,r=g.p.treeReader.loaded,q,n,u,v,x;q=0;var t=e,y;void 0===f&&(f=!1);if(void 0===b||null===b){x=g.p.data.length-1;if(0<=x)for(;0<=x;)q=Math.max(q,parseInt(g.p.data[x][g.p.localReader.id],
10)),x--;b=q+1}var B=a(g).jqGrid("getInd",e);y=!1;void 0===e||null===e||""===e?(t=e=null,q="last",v=g.p.tree_root_level,x=g.p.data.length+1):(q="after",n=g.p._index[e],u=g.p.data[n],e=u[g.p.localReader.id],v=parseInt(u[k],10)+1,x=a(g).jqGrid("getFullTreeNode",u),x.length?(t=x=x[x.length-1][g.p.localReader.id],x=a(g).jqGrid("getInd",t)+1):x=a(g).jqGrid("getInd",e)+1,u[h]&&(y=!0,u[d]=!0,a(g.rows[B]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(g.p.treeIcons.leaf+
" tree-leaf").addClass(g.p.treeIcons.minus+" tree-minus"),g.p.data[n][h]=!1,u[r]=!0));n=x+1;void 0===c[d]&&(c[d]=!1);void 0===c[r]&&(c[r]=!1);c[k]=v;void 0===c[h]&&(c[h]=!0);"adjacency"===g.p.treeGridModel&&(c[l]=e);if("nested"===g.p.treeGridModel){var w;if(null!==e){h=parseInt(u[m],10);k=a.jgrid.from(g.p.data);k=k.greaterOrEquals(m,h,{stype:"integer"});k=k.select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=k[w][p]>h?parseInt(k[w][p],10)+2:k[w][p],k[w][m]=k[w][m]>=h?parseInt(k[w][m],10)+
2:k[w][m]);c[p]=h;c[m]=h+1}else{h=parseInt(a(g).jqGrid("getCol",m,!1,"max"),10);k=a.jgrid.from(g.p.data).greater(p,h,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=parseInt(k[w][p],10)+2);k=a.jgrid.from(g.p.data).greater(m,h,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][m]=parseInt(k[w][m],10)+2);c[p]=h+1;c[m]=h+2}}if(null===e||a(g).jqGrid("isNodeLoaded",u)||y)a(g).jqGrid("addRowData",b,c,q,t),a(g).jqGrid("setTreeNode",x,n);u&&!u[d]&&
...
function(a){return k(this,a,"jqmShow")};a.fn.jqmShow=function(b){return this.each(function(){a.jqm.open(this._jqm,b)})};a.fn.jqmHide=function(b){return this.each(function(){a.jqm.close(this._jqm,b)})};a.jqm={hash:{},open:function(b,h){var k=e[b],r=k.c,q="."+r.closeClass,n=parseInt(k.w.css("z-index")),n=0<n?n:3E3,u=a("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":n-1,opacity:r.overlay/100});if(k.a)return f;k.t=h;k.a=!0;k.w.css("z-index",n);r.modal?(c[0]||setTimeout(function(){d("bind")},
1),c.push(b)):0<r.overlay?r.closeoverlay&&k.w.jqmAddClose(u):u=f;k.o=u?u.addClass(r.overlayClass).prependTo("body"):f;r.ajax?(n=r.target||k.w,u=r.ajax,n="string"==typeof n?a(n,k.w):a(n),u="@"==u.substr(0,1)?a(h).attr(u.substring(1)):u,n.html(r.ajaxText).load(u,function(){r.onLoad&&r.onLoad.call(this,k);q&&k.w.jqmAddClose(a(q,k.w));g(k)})):q&&k.w.jqmAddClose(a(q,k.w));r.toTop&&k.o&&k.w.before('<span id="jqmP'+k.w[0]._jqm+'"></span>').insertAfter(k.o);r.onShow?r.onShow(k):k.w.show();g(k);return f},
