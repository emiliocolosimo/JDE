...
QSH CMD('/QOpenSys/pkgs/bin/php /www/php80/htdocs/azureApps/onetime/sendHANNO0F.php')   
...
ini_set("error_log", "/www/php80/htdocs/azureApps/logs/sendHANNO0F_".date("Ym").".log");
