...
ini_set("error_log", "/www/php80/htdocs/logs/getF0005/php-error.log");
...
/*
//!! il file si trova solo in JRGCOM94T
$env = '';
...
/*
	Modifica la API F0005 in modo che prenda i dati F0005D con gli stessi parametri 
	usati fin’ora più DRLNGP=’I’; se non esiste un record con quei valori continua 
	a prendere i dati da F0005
*/ 
 
$qUnion1 = "
select drky, drdl01, drdl02, DRRT, DRSY , '    ' AS DRSPHD FROM JRGCOM94T.F0005D  
";
if($whrClause!="") $qUnion1.= $whrClause .' AND DRLNGP=\'I\' ';
else $qUnion1.= 'WHERE DRLNGP=\'I\'';

$subSelect1 = "
select drky FROM JRGCOM94T.F0005D  
";
if($whrClause!="") $subSelect1.= $whrClause .' AND DRLNGP=\'I\' ';
else $subSelect1.= 'WHERE DRLNGP=\'I\'';

$qUnion2 = "
select drky, drdl01, drdl02, DRRT, DRSY , DRSPHD FROM JRGCOM94T.F0005   
";
if($whrClause!="") $qUnion2.= $whrClause .' and drky not in ('.$subSelect1.') ';
else $qUnion2.= 'where drky not in ('.$qUnion1.')';

//query:
$query = "
SELECT T.DRKY AS DRKY,                                  
TRIM(T.DRDL01) AS DRDL01,                                     
TRIM(T.DRDL02) AS DRDL02,  
TRIM(T.DRRT) AS DRRT,  
TRIM(T.DRSY) AS DRSY,
TRIM(T.DRSPHD) AS DRSPHD
from table(                                                   
".$qUnion1."                                                             
union                                                         
".$qUnion2."                                            
