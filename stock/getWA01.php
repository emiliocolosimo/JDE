...
ini_set("error_log", "/www/php80/htdocs/logs/getWA01/php-error.log");
...
//query:
$query = "SELECT 
    TRIM(W1LITM) AS W1LITM,
    TRIM(W1DSC1) AS W1DSC1,
    TRIM(W1DL01) AS W1DL01,
    TRIM(W1DL02) AS W1DL02,
    TRIM(W1DL03) AS W1DL03,
    TRIM(W1R1UD) AS W1R1UD,
    TRIM(W1UOM1) AS W1UOM1,
    (W1QAVL)/100 AS W1QAVL,
    TRIM(W1DL04) AS W1DL04
FROM " . $curLib . ".F55WA01W 
";
